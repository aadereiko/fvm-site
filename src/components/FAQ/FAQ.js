  ...
  return (
    <FaqWrapper>
      <FaqBlock marginTop="80px" title="Как подать заявку на участие?">
        <P marginTop="24px"  weight="300" size="22px" height="27px">Где можно узнать свежие новости о проекте?<br/><br/>Нигде!<br/><br/>Всё уже, всё...<br/><br/>Отмена!</P>
        <P weight="300" size="22px" height="27px"></P>
        <P weight="300" size="22px" height="27px"></P>
        <P weight="300" size="22px" height="27px"></P>
      </FaqBlock>
