...
import { TeamWrapper, PersonContainer, Tg, Vk, Fb, Links, MobileWrapper } from './elements';
  ...
  return (
    <>
      {isLaptop ?
        ...
        :
        <MobileWrapper>
          <PersonContainer isMobile={!isLaptop}>
            <Image bgImage={marika} height="200px" width="200px" />
            <P marginTop="10px" weight="600" size="14px" height="16px">Чекуришвили Марика</P>
            <P weight="400" size="10px" height="12px" color="#8089DC">Руководитель проекта</P>
            <Button
              onClick={() => contactClick('marika')}
              contact={contact.active && contact.person === 'marika'}
              marginTop="32px"
          ...
          <PersonContainer isMobile={!isLaptop}>
            <Image bgImage={malceva} height="200px" width="200px" />
            <P marginTop="10px" weight="600" size="14px" height="16px">Мальцева Дарья</P>
            <P weight="400" size="10px" height="12px" color="#8089DC">Специалист по работе с партнёрами</P>
            <Button onClick={() => contactClick('malts')} contact={contact.active && contact.person === 'malts'} marginTop="32px" width={contact.active && contact.person === 'malts' ? "288px" : "121px"}>{
              <P paddingLeft={contact.active && contact.person === 'malts' && "21px"} size="14px" height="16px" marginRight="auto">Связаться</P>} {
                contact.active && contact.person === 'malts' &&
                <Links>
          ...
          <PersonContainer isMobile={!isLaptop}>
            <Image bgImage={rostovceva} height="200px" width="200px" />
            <P marginTop="10px" weight="600" size="14px" height="16px">Ростовцева Дарья</P>
            <P weight="400" size="10px" height="12px" color="#8089DC">Специалист по связям с общественностью</P>
            <Button onClick={() => contactClick('rost')} contact={contact.active && contact.person === 'rost'} marginTop="32px" width={contact.active && contact.person === 'rost' ? "288px" : "121px"}>{
              <P paddingLeft={contact.active && contact.person === 'rost' && "21px"} size="14px" height="16px" marginRight="auto">Связаться</P>} {
                contact.active && contact.person === 'rost' &&
                <Links>
